...
const Testimonial = () => {
  ...
  return (
     ...
     <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
           ...
           <Title title="Don't just take our words" descriptions="Hear wht our users say about us. We're always looking for ways to imporve. If you have a positive experience with us, leave a review." />
    </div>
